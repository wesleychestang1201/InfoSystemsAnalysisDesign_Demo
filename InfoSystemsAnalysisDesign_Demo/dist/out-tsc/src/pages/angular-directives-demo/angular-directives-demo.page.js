...
var AngularDirectivesDemoPage = /** @class */ (function () {
    ...
    AngularDirectivesDemoPage.prototype.displayMessage = function () {
    ...
    AngularDirectivesDemoPage.prototype.changeLogoColor = function (color) {
    ...
    AngularDirectivesDemoPage = tslib_1.__decorate([
        Component({
    ...
    ], AngularDirectivesDemoPage);
    return AngularDirectivesDemoPage;
}());
export { AngularDirectivesDemoPage };
//# sourceMappingURL=angular-directives-demo.page.js.map